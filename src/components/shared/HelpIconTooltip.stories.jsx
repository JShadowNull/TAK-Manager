...
export const InteractionModes = () => (
  <div className="flex flex-col gap-8 p-4">
    ...
    <div className="flex flex-col gap-4">
      <h3 className="text-white font-medium">Standalone Help Icons:</h3>
      <div className="flex items-center gap-8">
        <div className="flex items-center gap-2">
          <span className="text-white">Click Mode:</span>
          <HelpIconTooltip 
        ...
        <div className="flex items-center gap-2">
          <span className="text-white">Hover Mode:</span>
          <HelpIconTooltip 
    ...
    <div className="flex flex-col gap-4">
      <h3 className="text-white font-medium">Buttons with Help Icons:</h3>
    ...
    <div className="flex flex-col gap-4">
      <h3 className="text-white font-medium">Inline with Text:</h3>
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-2">
          <span className="text-white">Important setting</span>
          <HelpIconTooltip 
            tooltip="Click for more information about this setting" 
            triggerMode="click"
          />
          <span className="text-gray-400">|</span>
          <span className="text-white">Another option</span>
          <HelpIconTooltip 
...
export const Positions = () => (
  <div className="flex flex-col gap-8 p-4">
    <h3 className="text-white font-medium">Tooltip Positions:</h3>
    <div className="grid grid-cols-2 gap-8">
      {['top', 'right', 'bottom', 'left'].map((side) => (
        <div key={side} className="flex items-center gap-2">
          <span className="text-white min-w-[80px]">{side}:</span>
          <HelpIconTooltip 
...
export const Sizes = () => (
  <div className="flex flex-col gap-8 p-4">
    <h3 className="text-white font-medium">Icon Sizes:</h3>
    <div className="flex items-center gap-8">
...
export const Variants = () => (
  <div className="flex flex-col gap-8 p-4">
    <h3 className="text-white font-medium">With Different Button Variants:</h3>
    <div className="flex items-center gap-4">
      <Button 
        variant="primary"
        showHelpIcon 
